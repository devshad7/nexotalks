...
const UserPanel = () => {
  ...
  return (
    <div className="flex flex-col h-full items-center py-6 px-4 space-y-8 bg-gray-200 dark:bg-gray-900 transition-colors duration-300">
      <div className="flex justify-between w-full items-center px-4">
        <h2 className="font-bold text-2xl ml-8 text-gray-900 dark:text-white">Chats</h2>
        <button onClick={openModal} className="text-gray-600 dark:text-gray-300 mr-1 hover:text-black dark:hover:text-white">
          <Plus size={24} />
        </button>
      </div>
      ...
      <div className="flex flex-col items-center justify-center flex-grow text-center text-gray-500 dark:text-gray-400 mb-10 ml-6">
        <div className="flex flex-col items-center space-y-1">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="140" height="140" className="fill-current text-gray-400 dark:text-gray-600">
